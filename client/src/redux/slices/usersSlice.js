...
const usersSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // get users count
      .addCase(getUsersCount.pending, (state) => handleUsersLoading(state))
      ...
      .addCase(getUsersCount.rejected, handleUsersError)
      ...
      .addCase(getUsersActiveCount.rejected, handleUsersError);
  },
});
