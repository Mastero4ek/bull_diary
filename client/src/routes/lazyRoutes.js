...
export const LazyKeysPage = lazy(() => import('@/pages/info/KeysPage'));
export const LazyTuningPage = lazy(() => import('@/pages/info/TuningPage'));
...
export const lazyComponents = {
  ...
  KeysPage: LazyKeysPage,
  TuningPage: LazyTuningPage,
};
