...
import { SharedPopupLayout } from '@/components/layouts/popups/SharedPopupLayout'
...
export const SharedWalletPopup = React.memo(() => {
	...
	return (
		<SharedPopupLayout ref={ref} popup_id={'wallet-info'} popup_name={'wallet'}>
